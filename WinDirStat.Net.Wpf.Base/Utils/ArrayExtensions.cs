...
namespace TriggersTools.SharpUtils.Collections {
	...
	public static class ArrayExtensions {
		...
		/// </exception>
		public static void Memset(this Array array, object value, int startIndex,
			int length)
		{
			if (length < 0)
		...
		/// "https://stackoverflow.com/a/13806014/7517185">Source</a>
		/// </remarks>
		public static void Memset<T>(this T[] array, T value) {
			Memset(array, value, 0, array.Length);
		}
		...
		/// <paramref name="startIndex"/> or <paramref name="length"/> is less than zero.
		/// </exception>
		public static void Memset<T>(this T[] array, T value, int startIndex,
			int length)
		{
			if (length < 0)
				throw new ArgumentOutOfRangeException(nameof(length),
		...
		#region Memset (Multiple)

		/// <summary>Populates the entire array with the specified repeating values.</summary>
		/// <param name="array">The array to fill.</param>
		/// <param name="values">The ordered values to repeatedly populate the array with.</param>
		/// <returns>Returns the same array that was populated.</returns>
		/// 
		/// <remarks>
		/// Modified version of Memset created by TowerOfBricks: <a href=
		...
		/// <paramref name="values"/> has a length of zero.
		/// </exception>
		/// <exception cref="ArgumentNullException"><paramref name="values"/> is null.</exception>
		public static void Memset(this Array array, Array values) {
			array.Memset(values, 0, array.Length);
		}

		/// <summary>
		/// Populates the specified section of the array with the specified repeating values.
		/// </summary>
		/// 
		/// <param name="array">The array to fill.</param>
		/// <param name="values">The ordered values to repeatedly populate the array with.</param>
		/// <param name="startIndex">The index to start populating the array at.</param>
		/// <param name="length">The number of single elements to populate the array with.</param>
		/// <returns>Returns the same array that was populated.</returns>
		/// 
		/// <remarks>
		/// Modified version of Memset created by TowerOfBricks: <a href=
		...
		/// </exception>
		/// <exception cref="ArgumentNullException"><paramref name="values"/> is null.</exception>
		public static void Memset(this Array array, Array values, int startIndex,
			int length)
		{
			if (length < 0)
				throw new ArgumentOutOfRangeException(nameof(length),
				...
				throw new ArgumentException($"{nameof(values)} has a length of zero!",
					nameof(values));
			
			// Make sure the starting block is divisible by the number of values.
			int block = Math.Max(values.Length, (32 / values.Length) * values.Length);
			int index = startIndex;
			int end = startIndex + block;

			for (int i = 0; i < block; i++)
				array.SetValue(values.GetValue(i), index++);

			end = startIndex + length;
			while (index < end) {
				Array.Copy(array, 0, array, index, Math.Min(block, end - index));
				index += block;
				block *= 2;
			}
		}
		...
		/// </exception>
		/// <exception cref="ArgumentNullException"><paramref name="values"/> is null.</exception>
		public static void Memset<T>(this T[] array, params T[] values) {
			array.Memset(values, 0, array.Length);
		}
		...
		/// </exception>
		/// <exception cref="ArgumentNullException"><paramref name="values"/> is null.</exception>
		public static void Memset<T>(this T[] array, T[] values, int startIndex,
			int length)
		{
			if (length < 0)
				throw new ArgumentOutOfRangeException(nameof(length),
