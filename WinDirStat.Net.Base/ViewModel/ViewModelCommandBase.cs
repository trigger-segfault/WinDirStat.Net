...
namespace WinDirStat.Net.ViewModel {
	...
	public abstract class ViewModelCommandBase : ViewModelBase {
		...
		public ViewModelCommandBase(IRelayCommandService relayCommand)
		...
		/// <param name="commandName">The name of the command to get or set.</param>
		/// <returns>The existing or created command.</returns>
		protected RelayUICommand GetCommand(string text, IImage icon, Action execute,
		...
		/// <param name="commandName">The name of the command to get or set.</param>
		/// <returns>The existing or created command.</returns>
		protected RelayUICommand GetCommand(string text, IImage icon, IShortcut keyGesture,
		...
		/// <param name="commandName">The name of the command to get or set.</param>
		/// <returns>The existing or created command.</returns>
		protected RelayUICommand<T> GetCommand<T>(string text, IImage icon, Action<T> execute,
			Func<T, bool> canExecute = null, [CallerMemberName] string commandName = null)
		{
			return GetCommand(text, icon, null, execute, canExecute, commandName);
		}
		...
		/// <param name="commandName">The name of the command to get or set.</param>
		/// <returns>The existing or created command.</returns>
		protected RelayUICommand<T> GetCommand<T>(string text, IShortcut keyGesture, Action<T> execute,
			Func<T, bool> canExecute = null, [CallerMemberName] string commandName = null)
		{
			return GetCommand(text, null, keyGesture, execute, canExecute, commandName);
		}
